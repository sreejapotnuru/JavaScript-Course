...
function checkWinner(avgDolhins, avgKoalas) {
    return avgDolhins >= 2 * avgKoalas ? `Dolhins win (${avgDolhins} vs ${avgKoalas})` : `Koalas win (${avgDolhins} vs ${avgKoalas})`;
}
...
const tips = [125 * calcTip(bills[0]), 555 * calcTip(bills[1]), 44 * calcTip(bills[2])];
